...
const CoursesPage = () => {
    return (
      <div className="content">
        ...
        <p>
          Vivekanand College offers a wide range of undergraduate and postgraduate programs designed to meet today’s global education standards.
        </p>
        ...
        <div className="call-to-action">
          ...
          <a className="btn" href="/contactpage">
