...
import '../pages/AdmissionsPage.css';
        ...
        <div className="content">
            ...
            <ol>
                ...
                <li>
                    ...
                    " Upload scanned copies of required documents (mark sheet, ID proof, etc.)."
                </li>
                <li>
                    <b>Entrance Exam:</b>
            ...
            <p>
                ...
                <a href="" data-discover="true">Courses Page</a> or <a href="" data-discover="true">Contact Page</a> directly.
            </p>
            <div>
                <Footer/>
            </div>
